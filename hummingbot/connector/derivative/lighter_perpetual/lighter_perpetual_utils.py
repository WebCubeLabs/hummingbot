...
class LighterPerpetualConfigMap(BaseConnectorConfigMap):
    """Configuration map for Lighter Perpetual mainnet connector."""
...
OTHER_DOMAINS_EXAMPLE_PAIR = {"lighter_perpetual_testnet": "ETH-USDC"}
OTHER_DOMAINS_DEFAULT_FEES = {"lighter_perpetual_testnet": [0.00002, 0.0002]}
