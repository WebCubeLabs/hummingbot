...
# API Endpoints
META_INFO = "markets"
ASSET_CONTEXT_TYPE = "perpetualMarkets"
TRADES_TYPE = "userFills"
ORDER_STATUS_TYPE = "orderStatus"
USER_STATE_TYPE = "accountState"

# REST API Endpoints
TICKER_PRICE_CHANGE_URL = "/api/v1/perpetualMarkets"
SNAPSHOT_REST_URL = "/api/v1/orderBookDetails"
EXCHANGE_INFO_URL = "/api/v1/perpetualMarkets"
...
SET_LEVERAGE_URL = "/api/v1/sendTx"  # Leverage is set via updateLeverage transaction
GET_LAST_FUNDING_RATE_PATH_URL = "/api/v1/fundingRate"
...
POSITION_ENDPOINT_NAME = "positions"
FUNDING_RATE_ENDPOINT_NAME = "fundingRate"
...
ORDER_STATE = {
    ...
    "reduce_only_canceled": OrderState.CANCELED,
    "liquidated_canceled": OrderState.CANCELED,
}
...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=CANCEL_ORDER_URL, limit=10, time_interval=60,
              linked_limits=[LinkedLimitWeightPair(ALL_ENDPOINTS_LIMIT, weight=WEIGHT_SEND_TX)]),
    RateLimit(limit_id=SET_LEVERAGE_URL, limit=10, time_interval=60,
              linked_limits=[LinkedLimitWeightPair(ALL_ENDPOINTS_LIMIT, weight=WEIGHT_SEND_TX)]),
    ...
    RateLimit(limit_id=TICKER_PRICE_CHANGE_URL, limit=1, time_interval=60,
              linked_limits=[LinkedLimitWeightPair(ALL_ENDPOINTS_LIMIT, weight=WEIGHT_PUBLIC_DATA)]),
    RateLimit(limit_id=GET_LAST_FUNDING_RATE_PATH_URL, limit=1, time_interval=60,
              linked_limits=[LinkedLimitWeightPair(ALL_ENDPOINTS_LIMIT, weight=WEIGHT_PUBLIC_DATA)]),
    ...
    RateLimit(limit_id=ACCOUNT_TRADE_LIST_URL, limit=1, time_interval=60,
              linked_limits=[LinkedLimitWeightPair(ALL_ENDPOINTS_LIMIT, weight=WEIGHT_ACCOUNT_DATA)]),
    RateLimit(limit_id=POSITION_INFORMATION_URL, limit=1, time_interval=60,
              linked_limits=[LinkedLimitWeightPair(ALL_ENDPOINTS_LIMIT, weight=WEIGHT_ACCOUNT_DATA)]),
