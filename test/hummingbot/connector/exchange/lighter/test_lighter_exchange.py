...
import hummingbot.connector.exchange.lighter.lighter_web_utils as web_utils
...
class LighterExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    def create_exchange_instance(self):
        ...
        client_config_map.connector.lighter_api_key = self.api_key
        client_config_map.connector.lighter_api_secret = self.api_secret
        client_config_map.connector.lighter_account_index = self.account_index
        client_config_map.connector.lighter_api_key_index = self.api_key_index
    ...
    @aioresponses()
    def test_create_order_with_invalid_position_action(self, mock_api):
        # Spot exchanges don't support position actions
        pass
